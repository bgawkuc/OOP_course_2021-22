...
class AnimalTest {
    ...
    String[] array1 = new String[] {"f","f","f"};
    ...
    String[] array2 = new String[] {"f","b","b"};
    ...
    public void testShouldKnowIfAnimalClassWorksGood() {
        ...
        assertEquals(vector1, animal1.getPosition());
        ...
        assertEquals(vector2a, animal2.getPosition());
        animal2.move(MoveDirection.BACKWARD);
        assertEquals(vector2b, animal2.getPosition());
